...
root = "/media/data/umutlu/AIC20_track4/test-data/"
dest_dir = "/media/data/umutlu/AIC20_track4/test_ori_images/"
video_names = [str(i)+'.mp4' for i in range(4,101)]
...
dest_dir_processed = "/media/data/umutlu/AIC20_track4/test_processed_images/"
...
for i in tqdm.tqdm(range(1,101)):
    ...
    for j in range(4,5):
        ...
        former_im = cv2.imread(dest_dir+"%d/1.jpg"%i)
