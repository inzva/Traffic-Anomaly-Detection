...
from mmdet.utils.registry import BACKBONES
from mmdet.utils import build_norm_layer
...
def make_res_layer(block,
    ...
    layers = []
    if dcn=='all' or dcn == True:
        dcn=[tmp_dcn]*blocks
    elif dcn=='last':
        dcn=[None]*blocks
        dcn[-1]={'modulated': False, 'deformable_groups': 1, 'fallback_on_stride': False}
    else:
        dcn=[None]*blocks
    # print(dcn)
    layers.append(
